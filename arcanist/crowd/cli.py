...
class CliApplication:
    ...
    def initialize_cli(self):
        ...
        parser = argparse.ArgumentParser(
            description=MAIN_TITLE, usage="%(prog)s [options] <action>"
        )
        parser.add_argument(
            "action",
            type=str,
        ...
        parser.add_argument(
            ...
            "--rom",
            type=str,
            help="Path to the romfs directory. Required.",
            required=True,
            default=None,
        )
        parser.add_argument(
            ...
            choices=["BD", "BS"],
            default="BD",
            help="Game type. Defaults to Bravely Default (BD)",
        )
        parser.add_argument(
            "-o",
            "--output-dir",
            type=str,
            default=None,
            help="Target output directory. Defaults to romfs_{action}.",
        )
