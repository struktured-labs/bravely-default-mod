...
def main():
    ...
    patch_offset = reserve_empty_region(
        regions=regions,
        used_by="always_hasten_world_patch",
        disable_region_reserve=disable_region_reserve,
    )
    fake_struct_addr = reserve_empty_region(
        regions=regions,
        used_by="always_hasten_world_patch_fake_struct",
        disable_region_reserve=disable_region_reserve,
    )
    ...
    patch(
        ...
        fake_struct_addr=fake_struct_addr,
    )
